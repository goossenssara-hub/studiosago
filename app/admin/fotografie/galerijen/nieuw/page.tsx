      ...
      <section className={styles.layout}>
        ...
        <section className={styles.contentCard}>
          ...
          <div className={styles.formArea}>
            ...
            {step === 8 && <PublishStep form={form} uploads={uploads} coverId={coverId} setCoverId={setCoverId} moveUpload={moveUpload} reorderUpload={reorderUpload} draggedPhotoId={draggedPhotoId} setDraggedPhotoId={setDraggedPhotoId} dragOverPhotoId={dragOverPhotoId} setDragOverPhotoId={setDragOverPhotoId} />}
          </div>
    ...
    <div className={styles.sectionCard}>
      ...
      {props.uploads.length > 0 && (
        <div className={styles.uploadedArea}>
          <div className={styles.uploadSummary}><div><strong>{props.uploads.length} foto&apos;s toegevoegd</strong><span>{formatBytes(props.uploads.reduce((sum, item) => sum + item.file.size, 0))} · Sleep de kaarten om de galerijvolgorde te wijzigen</span></div><button type="button" onClick={() => props.inputRef.current?.click()}>+ Meer toevoegen</button></div>
    ...
    <div className={styles.publishStack}>
      ...
      <div className={styles.sectionCard}>
        <div className={styles.sectionHeading}>
          ...
          <p>Sleep via het greepicoon of gebruik de pijlen. Deze volgorde wordt exact gepubliceerd.</p>
        </div>
          ...
          {uploads.map((item, index) => (
            ...
            >
              <div className={styles.publishPhotoImage}>
                ...
                <span className={styles.publishOrder}>{index + 1}</span>
