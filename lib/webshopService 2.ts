...
const builtInServices: Record<string, Omit<DynamicService, "id">> = {
  "tekstcorrectie": {
    ...
    subtitle: "Tarief wordt berekend op basis van het aantal woorden",
    category: "Correctie van teksten",
    description:
      "We kijken je tekst na op spelling, grammatica, zinsbouw, formulering en leesbaarheid. €20 tot en met 2.000 woorden, daarna €8 per begonnen 1.000 extra woorden. De prijs wordt automatisch berekend.",
    price: 20,
  ...
  "5-beurtenkaart-lager": {
    title: "5-beurtenkaart Lager onderwijs",
    subtitle: "Vijf individuele begeleidingsmomenten",
    category: "Lager onderwijs",
    description: "Vijf individuele begeleidingsmomenten van één uur, digitaal of aan huis binnen 15 km rond Peer.",
    price: 165,
    button_text: "Koop je beurtenkaart",
    href: "/webshop/5-beurtenkaart-lager",
    slug: "5-beurtenkaart-lager",
    event_dates: null,
    image_url: null,
    is_visible: true,
    sort_order: 30,
  ...
  "10-beurtenkaart-lager": {
    ...
    subtitle: "Tien individuele begeleidingsmomenten",
    category: "Lager onderwijs",
    description: "Tien individuele begeleidingsmomenten van één uur, digitaal of aan huis binnen 15 km rond Peer.",
    price: 320,
    button_text: "Koop je beurtenkaart",
    href: "/webshop/10-beurtenkaart-lager",
    slug: "10-beurtenkaart-lager",
    event_dates: null,
    image_url: null,
    is_visible: true,
    sort_order: 31,
  ...
  "5-beurtenkaart-secundair": {
    title: "5-beurtenkaart Secundair onderwijs",
    subtitle: "Vijf individuele begeleidingsmomenten",
    category: "Secundair onderwijs",
    description: "Vijf individuele begeleidingsmomenten van één uur, digitaal of aan huis binnen 15 km rond Peer.",
    price: 195,
  ...
  "10-beurtenkaart-secundair": {
    ...
    slug: "10-beurtenkaart-secundair",
    event_dates: null,
    image_url: null,
    is_visible: true,
    sort_order: 31,
